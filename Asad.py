...
\033[1;91m☞ Auther     : Asad sindhi
\033[1;92m☞ WhatsApp   : 030......
\033[1;95m☞ YouTube    : https://nhi hy
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Asad Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Asad WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num nhi dunga✓')
	    psb('WellCome To Asad sindhi')
	    psb('Congratulations Asad Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Asad✓')
	    psb('🔓Password ☆ Laghari✓')
	    psb('hello✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Asad && python2 B4.py')
	elif bm =='3':
